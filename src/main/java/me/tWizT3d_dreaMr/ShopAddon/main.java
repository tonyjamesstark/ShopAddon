...
public class main extends JavaPlugin {
    ...
    private boolean areAble() {
        ...
        TransAmount =
                matchMaterial(getConfig().getString("Gui.Material.TransAmount"), Material.DIRT);
    ...
    public List<String> onTabComplete(
            CommandSender sender, Command obj, String alias, String[] args) {
        ...
        if (cmd.equals("searchshops")) {
            ...
            switch (args[0].toLowerCase()) {
                ...
                case "loredName":
                    ...
                    return ret;
                default:
                    ret.add(" player"); // leading spaces so they show up first, does not affect
                    // execution
                    ret.add(" loredName");
