...
public class MyListSearchResultsWindow extends MyListShopsWindow {
    ...
    public MyListSearchResultsWindow(UUID player, OfflinePlayer toSearch) {
        ...
        // TODO: could consider using com.snowgears.shop.gui.ListPlayersWindow (for selection) and
        // ListPlayerShopsWindow (for results)
        initInvContents();
    }
    ...
    protected List<Predicate<AbstractShop>> collectFilters() {
        ...
        switch (searchType) {
            ...
            case ITEM:
                filters.add(
                        shop ->
                                (((shop.getItemStack() != null)
                                                && (shop.getItemStack()
                                                        .getType()
                                                        .equals(itemSearched)))
                                        || ((shop.getSecondaryItemStack() != null)
                                                && (shop.getSecondaryItemStack()
                                                        .getType()
                                                        .equals(itemSearched)))));
                break;
            case NONE:
    ...
    protected void makeMenuBarUpper() {
        ...
        ItemStack settingsIcon =
                Shop.getPlugin()
                        .getGuiHandler()
                        .getIcon(ShopGuiHandler.GuiIcon.HOME_SETTINGS, null, null);
